...
```{r plot horses, fig.width=10, fig.height=3, fig.cap="Figure 1. Plot of All Provinces", fig.align='center'}
...
```{r plot province, fig.width=5, fig.height=4, fig.cap="Figure 2. Plot of the selected Province", fig.align='center'}
...
Console: `rmarkdown::render("doc/hist_horse_pop.Rmd")`

Terminal: `Rscript -e "rmarkdown::render('doc/hist_horse_pop.Rmd')"`

Terminal with params -   `Rscript -e "rmarkdown::render('doc/hist_horse_pop.Rmd', output_format = 'pdf_document', params=list(province='British Columbia'))"`
